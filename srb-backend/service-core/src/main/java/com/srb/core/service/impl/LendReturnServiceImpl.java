...
public class LendReturnServiceImpl extends ServiceImpl<LendReturnMapper, LendReturn> implements LendReturnService {
    ...
    public Result selectByLendId(Long lendId) {
        ...
        List<LendReturn> lendReturnList = list(queryWrapper);
        return Result.ok().data("row",lendReturnList);
    }
    ...
    public void notify(Map<String, Object> paramMap) {
        ...
        //获取还款数据
        QueryWrapper<LendReturn> queryWrap=new QueryWrapper<>();
        queryWrap.eq("return_no",agentBatchNo);
        LendReturn lendReturn = baseMapper.selectOne(queryWrap);
        ...
        TransFlowBO transFlowBO = new TransFlowBO(
                ...
                "借款人还款扣减:"+lend.getLendNo()+".项目名称"+lend.getTitle());
        ...
        lendItemReturnList.forEach(item->{
            ...
            TransFlowBO investTransFlow = new TransFlowBO(
                    ...
                    "还款到账:"+lend.getLendNo()+".项目名称"+lend.getTitle());
